...
+ (void)load {
    ...
    if ([[PMUserDefaults standardUserDefaults] boolForKey:@"enableWKWebViewMonitoring_CocoaDebug"]) {
...
- (instancetype)replaced_initWithFrame:(CGRect)frame configuration:(WKWebViewConfiguration *)configuration {
    //WKWebView
    [_ObjcLog logWithFile:"[WKWebView]" function:"" line:0 color:UIColor.mainGreen message:@"----------------------------------- init -----------------------------------"];
